...
require_once WPAB_DIR . 'includes/class-wpab-seo.php';
require_once WPAB_DIR . 'includes/class-wpab-builder.php';
...
require_once WPAB_DIR . 'includes/class-wpab-dashboard.php';
