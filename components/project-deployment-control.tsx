        ...
        <div className="mx-5 mt-5 rounded-xl border border-amber-200 bg-amber-50 p-4 text-sm text-amber-700 sm:mx-6">
          {!data.bridge.connected
            ...
            : !data.bridge.preflight || !data.bridge.createFiles
              ? "Install WP AI Builder Bridge v0.5.0 or newer to use build-mode preflight and controlled new-file creation."
              : "Bridge v0.5 is installed, but controlled writes are disabled. In WordPress open AI Builder → Controlled writes and enable them."}
        </div>
      )}
